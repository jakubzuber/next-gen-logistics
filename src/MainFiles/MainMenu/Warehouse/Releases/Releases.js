...
import { Topic, FunctionButtons, StyledButton, StyledSelect } from "../../styled";
...
import { assignWhWorker, clearWorker, fetchReleses, removeOrder, selectReleses } from './relesesSlice';
...
const Releses = () => {
    ...
    return (
        <div>
            ...
            <Box sx={{ borderRadius: '7px', backgroundColor: '#1266d4' }}>
                ...
                <MaterialReactTable
                    ...
                    muiTableBodyRowProps={({ row }) => ({
                        onClick: () => { openDetials({ orderId: row.original.ID, clientId: row.original.KLEINT_ID }) },
                        hover: false,
            ...
            <NewReleases modal={modal} closeModal={closeModal} clients={clients} />
